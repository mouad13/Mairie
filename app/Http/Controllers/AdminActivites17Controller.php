<?php namespace App\Http\Controllers;
	...
	class AdminActivites17Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Organisateur','name'=>'organisateur','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Animateur','name'=>'animateur','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Fk Lieu','name'=>'fk_lieu','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Descriptif','name'=>'descriptif','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
